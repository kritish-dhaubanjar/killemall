	...
	<div id="wrapper">	
		<div id="main">
			...
			<div class="container jumbotron" style="background-color:transparent; margin-bottom: 0px;">
			  <h1 class="display-4 text-center">Lab Reports</h1>
			  <p class=" lead text-center">Quick! Grab every reports!</p>
			</div>
			...
			<?php
				...
				for($i=0 ;$i<7; $i++){
					$count=0;
					$query="SELECT title, sn, acronym, link FROM labreports WHERE acronym='".$subject_acr[$i]."' ORDER BY id DESC";
